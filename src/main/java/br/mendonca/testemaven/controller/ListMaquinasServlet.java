...
@WebServlet("/dashboard/machines")
public class ListMaquinasServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            List<MaquinaDTO> lista = service.listAllMachines();

            request.setAttribute("lista", lista);
            request.getRequestDispatcher("list-maquinas.jsp").forward(request, response);
        } catch (Exception e) {
